...
Começaremos com uma exploração básica de algumas variávies do dataset. A começar pela variável resposta, `bank_account`.
...
p1 <- ggplot(perc_bank, aes(x = bank_account, y = n, fill = bank_account)) +
  ...
  labs(title = 'DESBALANÇO NA VARIÁVEL RESPOSTA',
       subtitle = 'CONTAGEM DO NÚMERO DE PESSOAS COM E SEM CONTA NO BANCO',
       fill = 'CONTA NO BANCO') +
  theme_minimal() +
